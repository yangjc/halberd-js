...
/**!phpjs;module:var
 */
exports.import_request_variables = function import_request_variables (types, prefix) {
  ...
  var _ini_get = function (ini) {
    if (module.php_js && module.php_js.ini && module.php_js.ini[ini] && module.php_js.ini[ini].local_value) { // Allow designated object to be used instead of window
      return module.php_js.ini[ini].local_value;
    }
    return false;
  };
