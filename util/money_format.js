 ...
 */
exports.money_format = function money_format (format, number) {
  ...
  module.setlocale('LC_ALL', 0); // Ensure the locale data we need is set up
  var monetary = module.php_js.locales[module.php_js.localeCategories['LC_MONETARY']]['LC_MONETARY'];
