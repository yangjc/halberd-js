...
/**!phpjs;module:array
 */
exports.array_uintersect_uassoc = function array_uintersect_uassoc (arr1) {
  ...
  cb = (typeof cb === 'string') ? module.window[cb] : (Object.prototype.toString.call(cb) === '[object Array]') ? module.window[cb[0]][cb[1]] : cb;
  cb0 = (typeof cb0 === 'string') ? module.window[cb0] : (Object.prototype.toString.call(cb0) === '[object Array]') ? module.window[cb0[0]][cb0[1]] : cb0;
