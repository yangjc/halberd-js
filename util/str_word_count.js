 ...
 */
exports.str_word_count = function str_word_count (str, format, charlist) {
  ...
  for (i = 0; i < len; i++) {
    ...
    match = module.ctype_alpha(c) || (reg && c.search(reg) !== -1) || ((i !== 0 && i !== len - 1) && c === '-') || // No hyphen at beginning or end unless allowed in charlist (or locale)
