...
/**!phpjs;module:array
 */
exports.extract = function extract (arr, type, prefix) {
  ...
  var targetObj = module.window;
  if (module.php_js && module.php_js.ini && module.php_js.ini['phpjs.extractTargetObj'] && module.php_js.ini['phpjs.extractTargetObj'].local_value) { // Allow designated object to be used instead of window
    targetObj = module.php_js.ini['phpjs.extractTargetObj'].local_value;
  }
  var chng = 0;
