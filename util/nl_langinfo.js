 ...
 */
exports.nl_langinfo = function nl_langinfo (item) {
  // http://kevin.vanzonneveld.net
  // +   original by: Brett Zamir (http://brett-zamir.me)
  // -    depends on: setlocale
  // *     example 1: nl_langinfo('DAY_1');
  // *     returns 1: 'Sunday'
  module.setlocale('LC_ALL', 0); // Ensure locale data is available
  var loc = module.php_js.locales[module.php_js.localeCategories.LC_TIME];
  if (item.indexOf('ABDAY_') === 0) {
    ...
    loc = module.php_js.locales[module.php_js.localeCategories.LC_MONETARY];
    if (item === 'CRNCYSTR') {
    ...
    loc = module.php_js.locales[module.php_js.localeCategories.LC_NUMERIC];
    switch (item) {
    case 'RADIXCHAR':
      // Fall-through
    case 'DECIMAL_POINT':
    ...
    loc = module.php_js.locales[module.php_js.localeCategories.LC_MESSAGES];
    switch (item) {
    case 'YESEXPR':
      // all fall-throughs
    case 'NOEXPR':
    ...
    loc = module.php_js.locales[module.php_js.localeCategories.LC_CTYPE];
    if (item === 'CODESET') {
